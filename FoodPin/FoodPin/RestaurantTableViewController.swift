...
class RestaurantTableViewController: UITableViewController,UpdateRestaurant,NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let managedObjectContext = (UIApplication.sharedApplication().delegate as? AppDelegate)?.managedObjectContext{
            ...
            do{
                ...
                restaurants = fetchedResultController.fetchedObjects as! [Restaurant]
            }catch{
                print(error)
            }
        }
